...
WAVE_AMPLITUDE = 1
WAVE_FREQUENCY = 40
LOW_FREQ_AMPLITUDE = 5
LOW_FREQ_FREQUENCY = 6
...
def create_continuous_wave_wall() -> gc.Path:
    ...
    layer_phase_shift = (layer_progress - BOTTOM_LAYERS) * WAVE_PHASE_SHIFT * 0.1
    low_freq_angle = theta * LOW_FREQ_FREQUENCY + layer_phase_shift
